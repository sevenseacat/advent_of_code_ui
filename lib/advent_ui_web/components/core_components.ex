defmodule AdventUIWeb.CoreComponents do
  @moduledoc """
  ...
  def home_link(assigns) do
    ~H"""
    <.link navigate="/" class="text-green-500 hover:text-green-400 hover:text-shadow shadow-green-400">
      [Home]
    </.link>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(AdventUIWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(AdventUIWeb.Gettext, "errors", msg, opts)
    # end
